          ...
          {loading ? (
            ...
            <div className="flex h-full flex-col items-center justify-center gap-2 p-8 text-center">
              ...
              <p className="text-xs leading-relaxed text-[#76534A]">
                When you message a chef from their public profile, your chats appear here. You can also start chats from
                any chef&apos;s profile page.
              </p>
            </div>
          ) : (
          ...
          {selectedConversation ? (
            ...
            <div className="flex h-full flex-col items-center justify-center gap-2 p-8 text-center">
              ...
              <p className="max-w-xs text-xs leading-relaxed text-[#76534A]">
                Pick a chef on the left to read and reply to their messages.
              </p>
            </div>
          )}
        </div>
