...
const Home = () => {
  ...
  const handleFindChefs = () => {
    navigate('/chefs');
  };

  const handleChefProfile = (chef) => {
    ...
    <main className="min-h-screen overflow-hidden bg-[#FFF9F5] text-chocolate">
      ...
      >
        ...
        <div className="relative mx-auto max-w-7xl px-5 sm:px-8 lg:px-10">
          ...
          <div className="grid min-h-170 items-center gap-8 py-12 lg:grid-cols-[1fr_0.9fr] lg:py-10">
            ...
            <div className="max-w-xl">
              ...
              <p className="mt-8 max-w-lg text-base leading-8 text-[#76534A] sm:text-lg">
                Explore local chefs, discover mouthwatering meals,
                and book a dining experience made just for you.
              </p>
            ...
            <div className="flex justify-center lg:justify-end">
              ...
              <div className="relative h-140 w-125">

                <div className="absolute left-23.75 top-3.25 z-0 h-26.25 w-26.25 rounded-full bg-[#F5D7E0]" />

                <div className="absolute bottom-18.75 right-8.75 z-0 h-31.25 w-31.25 rounded-full bg-[#F1DED4]" />

                <img
                  src="/images/chefhead.png"
                  alt="HomeChef chef"
                  className="absolute left-1/2 top-1/2 z-10 h-160.5 w-auto -translate-x-1/2 -translate-y-1/2 object-contain"
                />
      ...
      >
        <div className="mx-auto max-w-7xl px-5 sm:px-8 lg:px-10">
          ...
          <p className="mt-6 max-w-2xl text-sm leading-7 text-[#76534A]">
            Meet passionate chefs who bring their own style,
            experience, and love of food to every meal.
          </p>

          <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">

            {loadingChefs ? (
              <p className="text-sm text-[#92766E]">Loading best chefs...</p>
            ) : chefs.length === 0 ? (
              <p className="text-sm text-[#92766E]">No chefs available right now.</p>
            ) : (
              chefs.map((chef) => (
                <article
                  key={chef._id}
                ...
                >
                  ...
                  <div className="relative aspect-[4/4.6] overflow-hidden bg-[#FCECEF]">
                    ...
                    <img
                      src={chef.profileImage || chef.coverImage || '/images/chef-placeholder.jpg'}
                      alt={chef.name}
                    ...
                    <div className="absolute left-3 top-3 flex items-center gap-1 rounded-full bg-white px-3 py-1.5 text-xs font-semibold shadow-sm">
                      ...
                      {chef.averageRating > 0 ? (
                        ...
                        <>
                          <ChefHat size={13} className="text-[#B86A83]" />
      ...
      <section
        id="about"
        className="bg-[#FFF4F6] py-20 sm:py-24"
      >
        <div className="mx-auto max-w-7xl px-5 sm:px-8 lg:px-10">
          ...
          <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-20">
            ...
            <div className="relative">
              ...
              <div className="relative overflow-hidden rounded-[2.5rem]">
                ...
                <img
                  ...
                  className="h-107.5 w-full object-cover mix-blend-multiply sm:h-135"
                />
            ...
            <div className="max-w-xl">
              ...
              <p className="mt-7 text-sm leading-8 text-[#76534A] sm:text-base">
                HomeChef brings people and passionate chefs together
                over the love of good food. Whether you're craving a
                homemade favorite, planning a gathering, or simply
                looking for something new to taste, HomeChef helps you
                find the right chef for the occasion.
              </p>

              <p className="mt-5 text-sm leading-8 text-[#76534A] sm:text-base">
                Discover talented chefs, explore their specialties,
                choose what you love, and book with ease. For chefs,
                it's a place to showcase their skills, share their food,
                and connect with people who appreciate it.
              </p>
      ...
      <section
        id="why-us"
        className="bg-[#FFF9F5] py-20 sm:py-24"
      >
        <div className="mx-auto max-w-7xl px-5 sm:px-8 lg:px-10">
          ...
          <div className="max-w-2xl">
            ...
            <p className="mt-5 max-w-xl text-sm leading-7 text-[#76534A] sm:text-base">
              We make it easier to discover talented chefs,
              find food you love, and book a dining experience
              that feels personal.
            </p>
      ...
      <section className="bg-white px-5 py-20 sm:py-24">
        ...
        <div className="mx-auto max-w-5xl rounded-4xl bg-[#FFF2F5] px-6 py-16 text-center sm:px-12">
          ...
          <p className="mx-auto mt-5 max-w-xl text-sm leading-7 text-[#76534A] sm:text-base">
            Explore local chefs, discover something delicious,
            and book a dining experience made around what you love.
          </p>
